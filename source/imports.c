...
/* networking: the whole bionic socket surface (sockets, resolver, epoll,
 * eventfd, poll/select, and read/write/ioctl routing for sockets and emulated
 * fds) lives in nx_socket.c / nx_fdemu.c -- see nx_net.h. */
 ...
 * (Fix taken from the working colorsheep/cr3 Switch ports.) */
...
/* Correct pthread_once: exactly one thread runs init_routine, and every other
 * caller BLOCKS until that init has fully completed. The previous version let
 * late arrivers return immediately while init_routine was still running, so
 * they used half-initialized singletons/mutexes -> intermittent hangs.
 * States: 0 = not started, 1 = in progress, 2 = done. */
...
/* ===========================================================================
 * BTD5 supplementary imports. Bloons TD 5's engine imports a wider set than the
 * Angry Birds donor: extra GLES2/EGL entry points and libc, plus networking /
...
/* --- GL shader logging wrappers: BTD5 compiles shaders lazily during the first
 * frames; if mesa hangs or a shader fails to compile/link, these show exactly
 * where and print the driver's error log. --- */
...
void glShaderSource_log(GLuint s, GLsizei c, const GLchar *const *str, const GLint *len) {
  /* Concatenate the incoming source so we can (a) log it and (b) detect an
   * ES 1.00 body that the engine has wrapped with a 3.xx "#version" header
   * (attribute/varying/texture2D/gl_FragColor are illegal there -> compile
   * error/hang). If we see that mismatch, drop the bogus #version line. */
...
void glLinkProgram_log(GLuint p) {
  ...
  if (!ok) {
    ...
    lg[(n < (GLsizei)sizeof lg) ? n : (GLsizei)sizeof lg - 1] = 0;
    debugPrintf("gl: LINK ERROR: %s\n", lg);
  }
}

/* pthread attr helper: the donor already defines init/settype/cond_timedwait
 * (above); only destroy is missing, so add just that one here. */
...
DynLibFunction dynlib_functions[] = {
  ...
  { "gethostname", (uintptr_t)&nxs_gethostname },
  { "getpeername", (uintptr_t)&nxs_getpeername },
  { "getpid", (uintptr_t)&getpid },
  { "getpwuid", (uintptr_t)&getpwuid_fake },
  { "getsockname", (uintptr_t)&nxs_getsockname },
  { "getsockopt", (uintptr_t)&nxs_getsockopt },
  ...
  { "inet_addr", (uintptr_t)&nxs_inet_addr },
  { "inet_ntop", (uintptr_t)&nxs_inet_ntop },
  { "inet_pton", (uintptr_t)&nxs_inet_pton },
  { "ioctl", (uintptr_t)&nxs_ioctl },
  ...
  { "pipe", (uintptr_t)&nxf_pipe },
  { "poll", (uintptr_t)&nxf_poll },
  { "pow", (uintptr_t)&pow },
  ...
  { "write", (uintptr_t)&nxs_write },
  { "writev", (uintptr_t)&writev_fake },
  /* ---- BTD5 supplementary imports (generated) ---- */
  ...
  { "__FD_SET_chk", (uintptr_t)&nxf_fd_set_chk },
  ...
  { "accept", (uintptr_t)&nxs_accept },
  { "android_set_abort_message", (uintptr_t)&imp_retvoid },
  { "atoi", (uintptr_t)&atoi },
  ...
  { "epoll_create", (uintptr_t)&nxf_epoll_create },
  { "epoll_create1", (uintptr_t)&nxf_epoll_create1 },
  { "epoll_ctl", (uintptr_t)&nxf_epoll_ctl },
  { "epoll_wait", (uintptr_t)&nxf_epoll_wait },
  { "eventfd", (uintptr_t)&nxf_eventfd },
  { "execl", (uintptr_t)&imp_retm1 },
  { "flockfile", (uintptr_t)&flockfile },
  { "fork", (uintptr_t)&imp_retm1 },
  { "freeaddrinfo", (uintptr_t)&nxs_freeaddrinfo },
  { "freelocale", (uintptr_t)&imp_retvoid },
  { "ftruncate", (uintptr_t)&imp_retm1 },
  { "funlockfile", (uintptr_t)&funlockfile },
  { "getaddrinfo", (uintptr_t)&nxs_getaddrinfo },
  { "getc_unlocked", (uintptr_t)&getc_unlocked },
  { "getegid", (uintptr_t)&imp_ret0 },
  { "getgid", (uintptr_t)&imp_ret0 },
  { "gethostbyname", (uintptr_t)&nxs_gethostbyname },
  { "getpwuid_r", (uintptr_t)&imp_retm1 },
  { "getservbyname", (uintptr_t)&nxs_getservbyname },
  ...
  { "if_indextoname", (uintptr_t)&nxs_if_indextoname },
  { "if_nametoindex", (uintptr_t)&nxs_if_nametoindex },
  ...
  { "recvmsg", (uintptr_t)&nxs_recvmsg },
  { "rewind", (uintptr_t)&rewind_fake },
  { "select", (uintptr_t)&nxf_select },
  { "sendmsg", (uintptr_t)&nxs_sendmsg },
  { "sendto", (uintptr_t)&nxs_sendto },
  { "shutdown", (uintptr_t)&nxs_shutdown },
  { "signal", (uintptr_t)&signal },
  { "sincos", (uintptr_t)&sincos_w },
  { "sincosf", (uintptr_t)&sincosf_w },
  { "slCreateEngine", (uintptr_t)&slCreateEngine },
  { "socketpair", (uintptr_t)&nxs_socketpair },
  ...
  { "wcsxfrm_l", (uintptr_t)&wcsxfrm_lw },  { "posix_memalign", (uintptr_t)&posix_memalign_w },
};
